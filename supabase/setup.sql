-- =====================================================================
-- vie Eyelash Salon Dashboard : Supabase 一括セットアップ (ALL-IN-ONE)
--
-- これ1ファイルを Supabase Dashboard > SQL Editor に貼り付けて「Run」するだけで
-- 全スキーマ・API(RPC)・面談機能・初期データ・権限・Realtime設定が完了します。
-- 冪等（idempotent）なので、何度実行しても安全です。
--
-- 内容 = migrations/0001_init.sql + migrations/0002_reviews.sql + seed.sql
-- （CLI 派は supabase db push でも可。本ファイルは「1回で流したい」人向け）
-- =====================================================================


-- ╔═══════════════════════════════════════════════════════════════════╗
-- ║ PART 1 / 3 : 基本スキーマ + API (0001_init.sql)                     ║
-- ╚═══════════════════════════════════════════════════════════════════╝
...
-- ╔═══════════════════════════════════════════════════════════════════╗
-- ║ PART 2 / 3 : 月次面談・振り返り (0002_reviews.sql)                  ║
-- ╚═══════════════════════════════════════════════════════════════════╝
...
-- ╔═══════════════════════════════════════════════════════════════════╗
-- ║ PART 3 / 3 : 初期データ (seed.sql) — 店舗・既定スタッフ            ║
-- ╚═══════════════════════════════════════════════════════════════════╝
...
-- ダッシュボードの 設定タブ > バックエンド設定 で Supabase に切り替えてください。
-- =====================================================================
